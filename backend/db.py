...
def get_connection():
    ...
    if DB_MODE == "postgresql":
        try:
            import psycopg2
            # Vercel/Hosted Postgres often requires SSL
...
def init_db():
    ...
    """
    if not Config.DATABASE_URL and Config.DB_MODE == "postgresql":
        print("[DB WARNING] DATABASE_URL not set. Skipping DB initialization.")
        return
